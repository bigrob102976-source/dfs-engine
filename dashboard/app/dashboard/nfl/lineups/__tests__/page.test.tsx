    ...
    lineups: [
      {
        ...
        assignments: [
          { slot: "QB", draftkings_player_id: "1", name: "Owned QB", position: "QB", team: "BUF", salary: 7000, projected_ownership: 22.4 },
          { slot: "DST", draftkings_player_id: "2", name: "No Own DST", position: "DST", team: "MIA", salary: 3000, projected_ownership: null },
        ],
      },
    ],
    ...overrides,
