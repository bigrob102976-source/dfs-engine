...
function playerRow(overrides: Partial<PlayerRow> = {}): PlayerRow {
  return {
    ...
    chalkScore: 50, leverage: 5, tags: [], reasons: [], lineupStatus: null, matchStatus: null, eligibilityStatus: null, optimizerEligible: false, mlProjection: null, mlProjectionStatus: null, blueCollarProjection: null, blueCollarMatchStatus: null, raw: { snapshot: {}, ownership: null, pool: null },
    ...overrides,
  };
}
...
const EMPTY_PROPS = {
  ...
  mlCoverage: { eligiblePitchers: 0, projectedPitchers: 0, eligibleHitters: 0, projectedHitters: 0 },
};
