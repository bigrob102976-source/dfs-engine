...
-- -- see migrations-postgres/0017_probable_starters.sql (this file's
-- Postgres counterpart) for the full rationale -- identical DDL, shared
-- verbatim across both dialects like every other migration in this
-- project.
--
