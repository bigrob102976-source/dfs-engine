...
function playerRow(overrides: Partial<PlayerRow> = {}): PlayerRow {
  return {
    ...
    chalkScore: 50, leverage: 5, tags: [], reasons: [], lineupStatus: null, matchStatus: null, eligibilityStatus: "STARTING_HITTER", optimizerEligible: true, mlProjection: null, mlProjectionStatus: null, blueCollarProjection: null, blueCollarMatchStatus: null, raw: { snapshot: {}, ownership: null, pool: null },
    ...overrides,
  };
}
