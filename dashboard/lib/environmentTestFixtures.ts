...
export function buildGameEnvironmentReport(overrides: Partial<GameEnvironmentReport> = {}): GameEnvironmentReport {
  const base: GameEnvironmentReport = {
    ...
    weather: {
      ...
      current: { temperature_f: 78, humidity_percent: 55, wind_speed_mph: 9, wind_direction_degrees: 45, feels_like_f: 79, rain_percent: 5, air_density: null, precipitation_probability_percent: 5, precipitation_amount_mm: 0, weather_code: 0, wind_gusts_mph: 14 },
      first_pitch: { temperature_f: 76, humidity_percent: 56, wind_speed_mph: 10, wind_direction_degrees: 45, feels_like_f: 77, rain_percent: 5, air_density: null, precipitation_probability_percent: 5, precipitation_amount_mm: 0, weather_code: 0, wind_gusts_mph: 15 },
      mid_game: { temperature_f: 72, humidity_percent: 58, wind_speed_mph: 12, wind_direction_degrees: 45, feels_like_f: 72, rain_percent: 8, air_density: null, precipitation_probability_percent: 8, precipitation_amount_mm: 0, weather_code: 0, wind_gusts_mph: 17 },
      late_game: { temperature_f: 68, humidity_percent: 60, wind_speed_mph: 11, wind_direction_degrees: 45, feels_like_f: 67, rain_percent: 8, air_density: null, precipitation_probability_percent: 8, precipitation_amount_mm: 0, weather_code: 0, wind_gusts_mph: 16 },
      weather_risk_percent: 12,
      weather_status: "Low disruption risk",
    },
    weather_analysis: {
      game_id: "824238",
    ...
    vegas: {
      ...
      consensus_home_win_probability: null,
      consensus_away_win_probability: null,
      implied_runs_calculation_method: "mock_dampened_moneyline_skew",
      implied_runs_input_total: null,
      implied_runs_input_home_run_line: null,
      implied_runs_input_home_moneyline: null,
      implied_runs_input_away_moneyline: null,
